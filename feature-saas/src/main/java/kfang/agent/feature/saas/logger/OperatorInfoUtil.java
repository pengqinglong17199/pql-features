...
public class OperatorInfoUtil {
    ...
    public static void logOperatorInfo(LogLevel logLevel) {
        ...
        switch (logLevel) {
            case DEBUG:
                LogUtil.debug(log, LogModuleBaseEnum.OPERATOR_INFO, operatorInfo);
                break;
            case WARN:
                LogUtil.warn(log, LogModuleBaseEnum.OPERATOR_INFO, operatorInfo);
                break;
            case ERROR:
                LogUtil.error(log, LogModuleBaseEnum.OPERATOR_INFO, operatorInfo);
                break;
            default:
                LogUtil.info(log, LogModuleBaseEnum.OPERATOR_INFO, operatorInfo);
                break;
        }
    }
