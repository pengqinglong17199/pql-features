...
import kfang.agent.feature.saas.diff.annotations.OperationLogField;
import kfang.agent.feature.saas.diff.entity.OperationLogDefinition;
import kfang.agent.feature.saas.diff.entity.OperationLogDefinitionWrapper;
import kfang.agent.feature.saas.diff.entity.OperationLogEntity;
import kfang.agent.feature.saas.diff.entity.OperationLogFieldWrapper;
...
public abstract class OperationHandle {
    ...
    public final String handle(Object nowEntity, Object history, Class<?> clazz) throws Exception {
        ...
        List<OperationLogDefinition> mergeList = definitionList.stream()
                ...
                .sorted(Comparator.comparing(OperationLogDefinition::getMergeName)
                        .thenComparingInt(OperationLogDefinition::getOrder))
                .collect(Collectors.toList());
     ...
     * @return String
     */
    protected String stringFormat(List<String> formatList, boolean addOrEdit, Object nowValue, Object historyValue) {
