package kfang.infra.feature.monitor.core.processor;
...
import kfang.infra.feature.monitor.constants.MonitorConstant;
import kfang.infra.feature.monitor.model.ServiceMessage;
...
import static kfang.infra.feature.monitor.constants.ServiceHeartbeatKey.*;
...
public class MonitorCoreProcessor {
    ...
    private static void up(ServiceMessage serviceMessage) {
        send(SERVICE_UP_QUEUE, serviceMessage);
    }

    private static void heartbeat(ServiceMessage serviceMessage) {
        send(SERVICE_HEARTBEAT_QUEUE, serviceMessage);
    }

    private static void down(ServiceMessage serviceMessage) {
        send(SERVICE_DOWN_QUEUE, serviceMessage);
    }
